...
namespace BasicHologram
{
    ...
    protected:
        ...
        DirectX::XMFLOAT4X4 m_AHATPose;
        DirectX::XMFLOAT4X4 m_AHATRotation;
        DirectX::XMFLOAT4 m_AHATRotDeterminant;
        std::shared_ptr<SlateFrameRendererWithCV> m_markerDetector;
